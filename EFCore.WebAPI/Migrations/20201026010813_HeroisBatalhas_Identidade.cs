    ...
    public partial class HeroisBatalhas_Identidade : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndentidadesSecretas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndentidadesSecretas_Herois_HeroiId",
                        column: x => x.HeroiId,
                        principalTable: "Herois",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndentidadesSecretas_HeroiId",
                table: "IndentidadesSecretas",
                column: "HeroiId",
                unique: true);
        }
